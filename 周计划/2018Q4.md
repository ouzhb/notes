...
- [ ] 【W】11月23日前，调研Operator Framework概念，分析Kafka、Spark的开源Operator包使用方式，输出使用文档
        - [ ] 【D】11月21日，调研Operator Framework概念，理解应用场景，以及工作原理
                - [ ] 【本日进展】查阅Operator相关概念，搭建一个开发环境。
                - [ ] 【本日进展】详细调研后发现，自己开发组件Operator难度不小。主要存在以下问题：1、框架基于GO语言，需要一定语言基础；2、需要用到Kubernetes中的高级特性，如CRD、statefulset、PV/PVC；3、当前Operator的文档很少。计划优先了解Kubernetes中的高级特性，之后直接分析Git上的开源Operator组件，自己不进行开发。
        - [ ] 【D】11月22日，了解并使用Kubernetes中的PV&PVC特性，输出使用文档。
                - [ ] 【本日进展】了解k8s的PV&PVC特性，输出使用文档
                - [ ] 【临时任务】定位IBNS研究院环境流处理堆积的问题，目前进展：卡顿的原因是smp-info,smp-auth,smp-history这三个topic影响流处理的速度，这三个topic只有1个或3分区。流处理移除这三个分区后运行正常。
        - [ ] 【D】11月23日，了解并使用Kubernetes中的statefulset特性，输出使用文档。
                - [ ] 【本日进展】了解Kubernetes中的POD的高级特性（如Hook、InitContainer、Preset、PDB、设计模式等概念）输出文档[参考](https://github.com/LinQing2017/notes/blob/master/kube-learn/workloads/pods/pod.md)
  
- [ ] 【W】11月26日前，调研Operator Framework概念，分析Kafka、Spark的开源Operator包使用方式，输出使用文档
        - [ ] 【D】11月26日，了解Kubernetes中控制器，包括ReplicaSet、ReplicationController、DaemonSet、Deployments
                - [ ] 【本日进展】 了解Kubernetes下的各种控制器，以StatefulSets为主。
                - [ ] 【本日进展】 了解Kubernetes给出的ZK部署方案，该方案基于StatefulSets能快速扩容、缩小，且无需绑定节点。
        - [ ] 【D】11月27日，了解Kubernetes中控制器，包括StatefulSets、Garbage Collection、TTL Controller
                - [ ] 【本日进展】 学习Kubernetes以下特性：准入控制器、Taints&Toleration机制、Garbage Collection机制
                - [ ] 【本日进展】 使用GoogleCloudPlatform 提供的Spark-On-K8S-Operator，该工具自定义了一个K8S API用于提交Spark任务，并且实现指标采集等功能。
                - [ ] 【临时任务】 定位WIS集群HDFS 丢块问题（Client配置1个副本，磁盘损坏导致文件丢失）
        - [ ] 【D】11月28日，深入了解GoogleCloudPlatform Spark-On-K8S-Operator
        - [ ] 【D】11月29日，使用Google开源Spark Operator输出使用报告
        - [ ] 【D】11月29日，使用Confluent开源Kafka Operator输出使用报告